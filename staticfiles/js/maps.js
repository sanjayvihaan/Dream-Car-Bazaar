...
var locations=[
    [locationData('images/resource/listing/1-1.jpg', '5', '7', 'listing-single.html', "BMW M8 Gran Coupe Base - 2021", '$129 ', '', 'sky', 'flaticon-tent', 'Hotel', 'Now Closed', ), 40.94401669296697, -74.16938781738281, 1, '<i class="icon flaticon-desk-bell"></i>'],
    [locationData('images/resource/listing/1-2.jpg', '5', '8', 'listing-single.html', "Audi A8 L 55 - 2021",       '$129 ', '', 'pink', 'flaticon-cutlery', 'Restaurant', 'Now Closed', ), 40.77055783505125, -74.26002502441406, 2, '<i class="icon flaticon-cutlery"></i>'], 
    [locationData('images/resource/listing/1-3.jpg', '5', '9', 'listing-single.html', "Volvo XC90 - 2020",                '$129 ', '', 'purple', 'flaticon-tent', 'Art & History', 'Now Closed', ), 40.7427837, -73.11445617675781, 3, '<i class="icon flaticon-tent"></i>'], 
    [locationData('images/resource/listing/2-1.jpg', '5', '6', 'listing-single.html', "Mercedes-Benz S 560 - 2021 ", '$129 ', '', 'green', 'flaticon-shopping-bag', 'Shopping', 'Now Closed', ), 40.70437865245596, -73.98674011230469, 4, '<i class="icon flaticon-shopping-bag"></i>'], 
    [locationData('images/resource/listing/2-2.jpg', '5', '5', 'listing-single.html', "Mercedes-Benz S 560 - 2021 ", '$129', '', 'pink', 'flaticon-cutlery', 'Restaurant', 'Now Closed', ), 40.641311, -73.778139, 5, '<i class="icon flaticon-cutlery"></i>'], 
    [locationData('images/resource/listing/2-3.jpg', '5', '4', 'listing-single.html', "Land Rover Range Rover HSE Westminster", '$129 ', '', 'orange', 'flaticon-cutlery', 'Restaurant', 'Now Closed', ), 41.080938, -73.535957, 6, '<i class="icon flaticon-cutlery"></i>'], 
    [locationData('images/resource/listing/2-4.jpg', '5', '3', 'listing-single.html', "Bentley Bentayga V8 - 2020 ", '$129 ', '', 'dark-pink', 'flaticon-gym', ' Gym & Fitness ', 'Now Closed', ), 41.079386, -73.519478, 7, '<i class="icon flaticon-mirror"></i>'], 
];
